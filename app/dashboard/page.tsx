    ...
    <main className="mx-auto max-w-6xl p-6 space-y-6">
      <header className="space-y-1">
        ...
        <p className="text-sm text-muted-foreground">
          Snapshot of committed workload vs team capacity over the next 4 weeks.
        </p>
      </header>
                  ...
                  <div key={week.weekLabel} className="space-y-2">
                    <div className="flex items-center justify-between text-sm">
                      ...
                      <span className="text-muted-foreground">
                        {Math.round(week.committedHours)}h / {Math.round(week.capacityHours)}h — {utilization}%
                        {utilization > 100 && (
            ...
            <CardContent className="space-y-2">
              {atRiskWeeks.length > 0 ? (
                atRiskWeeks.map((week) => (
                  <div key={week.weekLabel} className="flex items-center justify-between text-sm">
                    <span className="font-medium">{week.weekLabel}</span>
